...
motor intake2 = motor(PORT7,false);
int conspeed = 80;
...
double heading;
// auton settings
int desiredValue = 200; // want motor to go 200 deg DV
int desiredTurnValue = 0; //TV
...
void usercontrol(void) {
    ...
    while (1) {
        ...
        if (Controller1.ButtonL1.pressing()){
          intake2.spin(forward, 80,percent);
        }
        else if (Controller1.ButtonL2.pressing()){
          intake2.spin(reverse, 80,percent);
        }
        else {
          intake2.stop();
        }
